...
public class AiringToday extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new TMDBOnTheAir().execute(query);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_airing_today, menu);
        return true;
    }
    ...
    public class TMDBOnTheAir extends AsyncTask {
        ...
        public ArrayList<HashMap<String, String>> displayOnTheAirShows()
            ...
            stringBuilder
                    .append("https://api.themoviedb.org/3/tv/airing_today");
    ...
    public class SecondaryAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            View vi = convertView;
            if (convertView == null)
                vi = inflater.inflate(R.layout.activity_airing_today, null);
            ...
            vi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    Intent intent = new Intent(AiringToday.this,
