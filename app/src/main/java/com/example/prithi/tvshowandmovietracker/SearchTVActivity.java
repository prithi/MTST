...
public class SearchTVActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String query = intent.getStringExtra(homeTV.EXTRA_QUERY);
    ...
    private class TMDBQueryManager extends AsyncTask {
        ...
        public ArrayList<HashMap<String, String>> search2(String query)
            ...
            stringBuilder.append("https://api.themoviedb.org/3/search/tv");
            ...
            try {
                ...
                return parse(covertInputStreamToString(stream));
            } finally {
                if (stream != null) {
                    stream.close();
                }
        ...
        private ArrayList<HashMap<String, String>> parse(String result) {
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    map.put(KEY_TITLE,
                            jsonMovieObject.getString("original_name"));
                    map.put(KEY_YEAR, jsonMovieObject.getString("first_air_date"));
                ...
                System.err.println(e + "parse!!");
                Log.d(DEBUG_TAG, "Error parsing JSON. String was: " + "parse "
                        + streamAsString);
            }
            return results;
        }

        public String covertInputStreamToString(InputStream stream) throws IOException,
    ...
    public class SecondaryAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            View vi = convertView;
            if (convertView == null)
                vi = inflater.inflate(R.layout.tv_result, null);
            ...
            vi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    Intent intent = new Intent(SearchTVActivity.this,
