...
public class myTVShows extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_tvshows);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_my_tvshows, menu);
        return true;
    }
    ...
    public ArrayList<HashMap<String, String>> listTV(){
        List<MyTV> list;
        ArrayList<HashMap<String, String>> results = new ArrayList<HashMap<String, String>>();
        ParseQuery<MyTV> query = ParseQuery.getQuery(MyTV.class);
        ...
        try {
                    ...
                    for (MyTV d : list) {
                        ...
                        String year = d.getTVYear();
                        String title = d.getTVTitle();
                        String rating = d.getTVRating();
                        String imgUrl = d.getTVIMGURL();
                        String synopsis = d.getTVSynopsis();
                        int id = d.getTVID();
            ...
            e.printStackTrace();
            Toast.makeText(myTVShows.this, "Error : "
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            vi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    Intent intent = new Intent(myTVShows.this,
