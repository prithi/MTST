...
public class DetailedViewTV extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ratingButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(DetailedViewTV.this,
        ...
        Button addTVButton = (Button) findViewById(R.id.buttonAddtoWatchlist);
        addTVButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                MyTV tv = new MyTV();
                int ids = (Integer.valueOf(id));
                tv.setUser(ParseUser.getCurrentUser());
                tv.setUsername(ParseUser.getCurrentUser().getUsername());
                tv.setTVID(ids);
                tv.setTVTitle(title);
                tv.setTVYear(year);
                tv.setTVRating(rating);
                tv.setTVSynopsis(synopsis);
                tv.setTVIMGURL(imgUrl);
                tv.saveEventually();

                Toast.makeText(DetailedViewTV.this, "Added : "
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_add_to_tvshow:
                MyTV tv = new MyTV();
                int ids = (Integer.valueOf(id));
                tv.setUser(ParseUser.getCurrentUser());
                tv.setUsername(ParseUser.getCurrentUser().getUsername());
    ...
    public class SecondaryAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            View vi = convertView;
            if (convertView == null)
                vi = inflater.inflate(R.layout.activity_detailed_view, null);
    ...
    private class TMDBCast extends AsyncTask<Object, Void, ArrayList<String>> {
        ...
        public ArrayList<String> getCast() throws IOException {
            ...
            stringBuilder.append("https://api.themoviedb.org/3/tv/" + id + "/credits");
    ...
    private class TMDBSynopsis extends
        ...
        public ArrayList<String> getSynopsis() throws IOException {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("https://api.themoviedb.org/3/tv/" + id);
            stringBuilder.append("?api_key=" + TMDB_API_KEY);
            URL url = new URL(stringBuilder.toString());
