...
public class onTheAirTV extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_on_the_air_tv, menu);
        return true;
    }
    ...
    public class TMDBOnTheAir extends AsyncTask {
        ...
        public ArrayList<HashMap<String, String>> displayOnTheAirShows()
            ...
            stringBuilder
                    .append("https://api.themoviedb.org/3/tv/on_the_air");
    ...
    public class SecondaryAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            View vi = convertView;
            if (convertView == null)
                vi = inflater.inflate(R.layout.activity_on_the_air_tv, null);
            ...
            vi.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    Intent intent = new Intent(onTheAirTV.this,
