...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void register(final View v){
        if (mUsernameField.getText().length() == 0 || mUsernameField.getText().length() == 0){
            return;
        }
                ...
                if (e == null){
                    ...
                    switch (e.getCode()) {
                        ...
                        case ParseException.PASSWORD_MISSING:
                            mErrorField.setText("Sorry, you must supply a password to regiser");
                            break;
                        default:
